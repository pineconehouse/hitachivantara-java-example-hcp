...
public class UploadRunnable implements Runnable {
	...
	public void run() {
		...
		try {
			...
			while (partData != null) {
				// 上传分片数据数据
				uploader.upload(partData.getPartIndex(), partData.getInputStream(), partData.getSize(), " by " + ID);
				partData.close();
			...
			log.println("Error occured when get part data. Index:" + partData.getPartIndex());
			e.printStackTrace();
			return;
		}
