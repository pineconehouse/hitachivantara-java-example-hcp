...
/**
 * Access HCP through native JDK
 * 
 * @author sohan
 *
 */
public class PureHSwiftExample_PutGetDeleteObject {

	public static void main(String[] args) throws MalformedURLException {
		// ********************************************************
		// !Attention!!Attention!!Attention!!Attention!!Attention!
		// HSwift API function must be enabled
		// ********************************************************
		...
		final String rest = protocol + "://api." + hcpdomain + "/swift/v1/" + tenant + "/" + namespace + "/"; // target path
		String key = "example-hcp/Test1-UploadedByHSwwiftAPI-1.log";
		...
		try {
			...
			connection.setRequestProperty("X-Auth-Token", Account.HCP_AUTHORIZATION); // 设置认证信息
